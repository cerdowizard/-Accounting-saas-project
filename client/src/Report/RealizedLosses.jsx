                        ...
                        <table className="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Realized Amount (NGN)</th>
                                    <th scope="col">Exchange Rate</th>
                                    <th scope="col">Realized Gain/Loss</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Totals Realized Gains & Losses</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
