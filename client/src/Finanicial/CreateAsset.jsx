                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="fs">
                                                    ...
                                                    <div className="select mt-2">
                                                        <label htmlFor="">Asset Life span</label>
                                                        <select
                                                            class="role"
                                                            aria-label="Default select example"
                                                        >
                                                            <option selected>Select asset life span</option>
                                            ...
                                            <div className="col-md-6 mt-4">
                                                <div className="fs" style={{
                                                    ...
                                                    <label htmlFor="">Assets Type</label>
                                        ...
                                        <div className="row mt-2">
                                            <div className="col-md-6">
                                                ...
                                                <div className="fs" style={{
                                                    ...
                                                    <div className="d-flex">
                                                        <input type="checkbox" onClick={Recurring} style={{
                                                            width: 20
                                                        }} />
                                                        <span>Constant amount</span>
                                                        <input type="checkbox" onClick={Billable} placeholder='Enter name or description' style={{
                                                            width: 25
                                                        }} />
                                                        <span>One-time amount</span>

                                                        
                                                        <input type="checkbox" onChange={clicked} placeholder='Enter name or description' style={{
                                                            width: 25
                                                        }} />
                                                        <span>Varying amounts over time</span>
                                                    </div>
                                                    {
                                                        isRecurring && <div style={{ display: 'block' }}>
                                                            ...
                                                            <div className="">
                                                                <div className="fs">
                                                                    <label htmlFor="">Asset Date</label>
                                                                    <div className="email-input">
                                                                        <input type="date" />
                                                                    </div>
                                                                </div>
